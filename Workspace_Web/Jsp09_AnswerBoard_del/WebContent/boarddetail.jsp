...
<body>
   ...
   <table border="1">
      <tr>
         <th>게시글 번호</th>
         <td>
         <jsp:getProperty property="boardno" name="dto"/>
         </td>
      </tr>
      <tr>
         <th>작  성  일</th>
      ...
      <tr>
         <td colspan="2">
			<input type="button" value="수정" onclick="location.href='answer.do?command=updateform&boardno=<jsp:getProperty property="boardno" name="dto"/>'">
