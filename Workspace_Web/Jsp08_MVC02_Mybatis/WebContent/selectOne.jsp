...
<body>
   ...
   <table border="1">
      ...
      <tr>
         <td colspan="2">
            <input type="button" value="수정" onclick="location.href='controller.do?command=updateform&seq=<jsp:getProperty property="seq" name="dto"/>'">
            <input type="button" value="삭제" onclick="location.href='controller.do?command=delete&seq=<jsp:getProperty property="seq" name="dto"/>'">
            <input type="button" value="뒤로가기" onclick="location.href='controller.do?command=list'">
         </td>
      </tr>
   </table>
