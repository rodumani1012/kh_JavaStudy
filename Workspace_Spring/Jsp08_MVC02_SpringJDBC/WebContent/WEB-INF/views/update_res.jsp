...
<body>
	...
	<jsp:useBean id="dto" class="com.spr.mvc.model.dto.MyMVCDto" scope="request"></jsp:useBean>

	<h1>글 수정</h1>
	
	<form action="update_res.spr" method="post">
		...
		<table border="1">
			...
			<tr>
				<td colspan="2">
					...
					<input type="button" value="뒤로가기" onclick="location.href='list.spr'">
				</td>
			</tr>
		</table>
	</form>
