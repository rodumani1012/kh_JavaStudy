		...
		for (int i = 0; i < 5; i++) {
			...
			case "6":
				...
				if (sel.equals("1")) {
					...
					else if(com == 2 || com == 3 || com == 4 || com == 5 || com == 6) {
				...
				if (sel.equals("2")) {
					...
					else if(com == 1 || com == 3 || com == 4 || com == 5 || com == 6) {
						System.out.println("막혔습니다.");
				...
				if (sel.equals("3")) {
					...
					else if(com == 1 || com == 2 || com == 4 || com == 5 || com == 6) {
						System.out.println("막혔습니다.");
				...
				if (sel.equals("4")) {
					...
					else if(com == 1 || com == 2 || com == 3 || com == 5 || com == 6) {
						System.out.println("막혔습니다.");
				...
				if (sel.equals("5")) {
					...
					else if(com == 1 || com == 2 || com == 3 || com == 4 || com == 6) {
						System.out.println("막혔습니다.");
				...
				if (sel.equals("6")) {
					...
					else if(com == 1 || com == 2 || com == 3 || com == 4 || com == 5) {
						System.out.println("막혔습니다.");
