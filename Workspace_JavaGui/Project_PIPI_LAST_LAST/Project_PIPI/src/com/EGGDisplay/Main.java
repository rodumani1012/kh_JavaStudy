...
import com.dayandnight.AllDay;
import com.dayandnight.DayAndNight;
...
public class Main extends JFrame implements ActionListener {
	...
	DayAndNight dan = null;
	AllDay all = new AllDay();
	...
	public Main() {
		...
		JButton button5 = new JButton("강제종료");
		DandN = new JLabel(born);

		eat.setBounds(1200, 150, 100, 30);
		joy.setBounds(1200, 200, 100, 30);
		button2.setBounds(1200, 250, 100, 30);
		button3.setBounds(1200, 300, 100, 30);
		button4.setBounds(1200, 350, 100, 30);
		button5.setBounds(1300, 600, 100, 30);
