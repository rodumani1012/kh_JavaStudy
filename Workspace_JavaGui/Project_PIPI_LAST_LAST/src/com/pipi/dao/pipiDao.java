...
public class pipiDao extends JDBCTemplate {
   ...
   //myno 별 select data    
      ...
      public static int updateStatus(pipiDto dto) {
         ...
         String sql = " UPDATE PIPIBOARD SET MYDISEASE='N', MYCLEAN=100 WHERE MYNO=? ";
         ...
         //병걸리기
         public static int updateDisease(int myno) {
            Connection con = getConnection();
             PreparedStatement pstm = null;
             int res = 0;
             
             String sql = " UPDATE PIPIBOARD SET MYDISEASE='Y' WHERE MYNO=? ";
         ...
         public static int updateInit(pipiDto dto) {
             Connection con = getConnection();
             PreparedStatement pstm = null;
             int res = 0;
             
             String sql = " UPDATE PIPIBOARD SET MYHEART = '100', MYFULL = '100', MYSTAMINA = '100', MYCLEAN = '100', MYDATE = '0', MYALLDAY = 'D' , MYDISEASE = 'N' , MYENABLED = 'Y' WHERE myid = ?";
             
             try {
                pstm = con.prepareStatement(sql);
               pstm.setString(1, dto.getMyid());
               // pstm.setInt(9, dto.getMyno());
