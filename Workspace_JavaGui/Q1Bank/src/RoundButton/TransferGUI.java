...
public class TransferGUI extends JFrame implements ActionListener {
	...
	private JLabel label_account, label_money, label_message, label_icon;
	...
	public TransferGUI(BankDto dto) {
		...
		ImageIcon CheckIcon = new ImageIcon(new ImageIcon("images/check_sign.png").getImage().getScaledInstance(25, 25, java.awt.Image.SCALE_SMOOTH));
		ImageIcon CrossIcon = new ImageIcon(new ImageIcon("images/cross_sign.png").getImage().getScaledInstance(25, 25, java.awt.Image.SCALE_SMOOTH));
		...
		//label_balance.setEnabled(false);
	...
	public void actionPerformed(ActionEvent e) {
		try {
			...
			JOptionPane.showMessageDialog(null, "계좌번호와 암호는 필수입력값입니다.");
