...
public class InfomationGui extends JFrame {
	...
	public InfomationGui() {
		super("?öå?õê?†ïÎ≥?");
		p = new JPanel();
		label_myid = new JLabel("?ïÑ   ?ù¥   ?îî : ");
		txt_myid = new JTextField(10);

		p1 = new JPanel();
		label_mypw = new JLabel("ÎπÑÎ?Î≤àÌò∏ : ");
		txt_mypw = new JTextField(10);

		p2 = new JPanel();
		label_myname = new JLabel("?ù¥         Î¶? : ");
		txt_myname = new JTextField(10);

		p3 = new JPanel();
		label_mydob = new JLabel("?Éù?ÖÑ?õî?ùº : ");
		txt_mydob = new JTextField(10);

		p4 = new JPanel();
		label_myaddr = new JLabel("Ï£?         ?Üå : ");
		txt_myaddr = new JTextField(10);

		p5 = new JPanel();
		label_mytel = new JLabel("?†Ñ?ôîÎ≤àÌò∏ : ");
		txt_mytel = new JTextField(10);

		p6 = new JPanel();
		update = new JButton("?àò?†ï");
		close = new JButton("?ã´Í∏?");
